...
export default function UpperProfileSection({ profile, isOwner, onUpdate, onUpdateSuccess,isAdminViewing }) {
  ...
  const onSubmit = async (data) => {
    ...
    dataToSend.append("expertise", data.expertise.toUpperCase());
                ...
                <Badge
                  ...
                  badgeContent={
                    isEditing ? (
                      ...
                      <VerifiedIcon sx={{ color: "#1DA1F2", bgcolor: "white", borderRadius: "50%", fontSize: 32, border: "2px solid white" }} />
                    )
                  }
                >
                  <Avatar
            ...
            <Box>
                ...
                {isEditing ? (
                  <Stack spacing={3} sx={{ width: "100%" }}>
                    ...
                    {/* Expertise Input (Replaces Interests) */}
                    <Controller
                        name="expertise"
                        control={control}
                        render={({ field: { onChange, value, ...rest } }) => (
                            <TextField 
                                ...
                                placeholder="DATA SCIENCE, MACHINE LEARNING, CLOUD SECURITY"
                                multiline
                                rows={2}
                                InputProps={{ startAdornment: <ExpertiseIcon sx={{ mr: 1, mt: 1, color: Colors.mediumDark }} /> }}
                  ...
                  <Box sx={{ width: "100%" }}> 
                    ...
                    <Box sx={{ display: "flex", flexWrap: "wrap", gap: 1, mb: 3, width: "100%" }}>
                      {parseList(teacherProfile.expertise).length > 0 ? (
                        ...
                        <Typography variant="body2" color="textSecondary">No expertise areas added yet.</Typography>
                      )}
                    </Box>
