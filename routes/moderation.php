...
Route::prefix('admin/moderation')->middleware(['auth:admin'])->group(function () {
    ...
    Route::get('/triage', [ModerationController::class, 'getGeneralQueue']);
    
    Route::post('/dismiss/{ideaId}', [ModerationController::class, 'dismissReports']);
    ...
    Route::delete('/user/{userId}', [ModerationController::class, 'permanentlyDeleteUser']);
});